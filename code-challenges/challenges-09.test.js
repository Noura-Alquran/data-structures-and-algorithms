...
function transformToLis(obj){
  // Solution code here...
  const array=[];
  let listForm = Object.keys(obj).map(function (key,value) {
     array.push(`<li>${key}: ${Object.values(obj)[value]}</li>`);
  })
  return array;
  console.log(array);
}
...
const addValues = (arr) => {
  // Solution code here...
 let addtion= arr.reduce(function(accumulator, currentValue) {
...
const addPurchases = (arr) => {
  // Solution code here...
  let addPurchase =arr.reduce(function(a,b){
  a= a+b.purchasePrice;
  return a;
  },0)
  return addPurchase;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let counter=arr.reduce(function(idx){
    idx++;
    return idx;
  },0)
  return counter;
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce( function(a,b,idx) {
    a.push(b.name);
    return a;
  },[]);
  return names;
...
const reversedString = (str) => {
  // Solution code here...
  const arr=str.split("");
  let reversedStr=arr.reduce(function(a,b,idx){
    a.push(arr[arr.length-(idx+1)]);
    return a;
  },[])
  let strAfter= reversedStr.join("");
  return strAfter;
};
