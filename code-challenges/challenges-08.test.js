...
const typeNum = (arr) => {
  // Solution code here...
  let filterArr=arr.filter(function(n){
...
const oddValues = (arr) => {
  // Solution code here...
  let checkOdd=arr.filter(function(n){
    return (n % 2 !== 0);
  })
  return checkOdd;
};
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let vowel=/[aeiouAEIOU]/i;
  let checkedVowels=arr.filter(function(n){
    return vowel.test(n);
  });
  console.log(checkedVowels);
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let checkedExist=arr.filter(function(n){
